...
//zenoh structs
typedef bit<3> attachment_encoding;
typedef bit<5> packet_type;
...
//zenoh definitions
const bit<3> ZENOH_PROPERTIES = 0;



const packet_type SCOUT = 1;
const packet_type INIT_PACKET = 3;
const packet_type OPEN_PACKET = 4;
const packet_type CLOSE_PACKET = 5;
const packet_type KEEPALIVE_PACKET = 8;
const packet_type ATTACHMENT = 0x1f;
const packet_type FRAME = 0x0a;
const packet_type DATA = 0x0c;
const packet_type DECLARE = 0x0b;
