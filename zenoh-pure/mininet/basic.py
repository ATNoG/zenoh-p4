...
class DemoTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        topo_file = json.load(open(os.path.join(sys.path[0], 'topology/topologyLinear5.json')))
...
def main():
    ...
    z1 = net.getNodeByName("z1")
    z1.popen("zenohd --listener udp/10.0.3.10:7447")
    sleep(5)
    
    h1 = net.getNodeByName("h1")
    h1.popen("python3.9 -u /mininet/ze_sub.py --host h1 --topic 1 --topics_to_listen 1")
    sleep(5)
