...
import org.onosproject.pipelines.zenoh_fabric.impl.behaviour.FabricPortStatisticsDiscovery;
...
import static org.onosproject.pipelines.zenoh_fabric.impl.FabricPipeconfManager.build;
...
public final class FabricPipeconfLoader {
    ...
    public static final String PIPELINE_APP_NAME = "org.onosproject.zenoh_app";
    ...
    private static final String BASE_PIPECONF_ID = "org.onosproject.zenoh_pipeline_extension";
