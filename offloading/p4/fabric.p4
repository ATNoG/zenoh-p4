...
#include "include/control/zenoh_broker.p4"
...
control FabricIngress (inout parsed_headers_t hdr,
    ...
    apply {
        ...
        if(fabric_metadata.isZenoh){
            ...
            zenoh_in.apply(hdr, fabric_metadata, standard_metadata);
        }else{
#ifdef WITH_SPGW
...
control FabricEgress (inout parsed_headers_t hdr,
    ...
    apply {
        _PRE_EGRESS
        if(fabric_metadata.isZenoh){
            zenoh_out.apply(hdr, fabric_metadata, standard_metadata);
        }
