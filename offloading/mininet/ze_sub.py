...
try:
    ...
    #sub2 = session.declare_subscriber(str(selector) + "2", sub_info, listener2)
    #sub3 = session.declare_subscriber(str(selector) + "3", sub_info, listener3)
    #sub4 = session.declare_subscriber(str(selector) + "4", sub_info, listener4)
    #sub5 = session.declare_subscriber(str(selector) + "5", sub_info, listener5)
